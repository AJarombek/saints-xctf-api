...
class TestUserRoute(TestSuite):
    def test_user_get_route_redirect(self) -> None:
        ...
        response: Response = self.client.get(
            "/v2/users", headers={"Authorization": f"Bearer {self.jwt}"}
        )
    ...
    def test_user_post_route_redirect_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "POST", "/v2/users", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_user_get_all_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/users/", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_user_post_route_400_empty_body(self) -> None:
        ...
        self.assertEqual(
            response_json.get("error"), "The request body isn't populated."
        )
    ...
    def test_user_post_route_400_invalid_activation_code(self) -> None:
        ...
        self.client.delete(
            "/v2/users/andy1", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        ...
        self.assertIsNone(response_json.get("user"))
        self.assertEqual(
            response_json.get("error"), "The activation code is invalid or expired."
        )
    ...
    def test_user_post_route_201(self) -> None:
        ...
        # Delete the user to void a duplicate entry constraint error.
        self.client.delete(
            "/v2/users/andy2", headers={"Authorization": f"Bearer {self.jwt}"}
        )
    ...
    def test_user_by_username_get_route_400(self) -> None:
        ...
        self.assertIsNone(response_json.get("user"))
        self.assertEqual(
            response_json.get("error"), "there is no user with this username"
        )
    ...
    def test_user_by_username_get_route_200(self) -> None:
        ...
        """
        response: Response = self.client.get(
            "/v2/users/andy", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 200)
    ...
    def test_user_by_username_get_route_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/users/andy", AuthVariant.FORBIDDEN
        )
    ...
    def test_user_by_username_get_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/users/andy", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_user_by_username_put_route_400_no_existing(self) -> None:
        ...
        self.assertIsNone(response_json.get("user"))
        self.assertEqual(
            response_json.get("error"), "there is no existing user with this username"
        )
    ...
    def test_user_by_username_put_route_400_updating_other_user(self) -> None:
        ...
        self.assertEqual(
            response_json.get("error"),
            "User andy is not authorized to update user andy2.",
        )
    ...
    def test_user_by_username_put_route_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "PUT", "/v2/users/andy", AuthVariant.FORBIDDEN
        )
    ...
    def test_user_by_username_put_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "PUT", "/v2/users/andy", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_user_by_username_delete_route_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "DELETE", "/v2/users/andy", AuthVariant.FORBIDDEN
        )
    ...
    def test_user_by_username_delete_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "DELETE", "/v2/users/andy", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_user_by_username_soft_delete_route_400_no_existing(self) -> None:
        ...
        self.client.delete(
            "/v2/users/invalid_user", headers={"Authorization": f"Bearer {self.jwt}"}
        )
    ...
    def test_user_by_username_soft_delete_route_400_other_user(self) -> None:
        ...
        """
        response: Response = self.client.delete(
            "/v2/users/soft/NewmanZone", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 400)
        self.assertFalse(response_json.get("deleted"))
        self.assertEqual(
            response_json.get("error"),
            "User andy is not authorized to soft delete user NewmanZone.",
        )
    ...
    def test_user_by_username_soft_delete_route_400_already_deleted(self) -> None:
        ...
        response: Response = self.client.post(
            "/v2/users/", data=request_body, content_type="application/json"
        )
        response_json: dict = response.get_json()
        self.assertEqual(
            response.status_code,
            201,
            msg=f'Error creating user: {response_json.get("error")}',
        )
        ...
        self.assertEqual(response.status_code, 400)
        self.assertEqual(
            "there is no existing user with this username", response_json.get("error")
        )
    ...
    def test_user_by_username_soft_delete_route_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "DELETE", "/v2/users/soft/andy3", AuthVariant.FORBIDDEN
        )
    ...
    def test_user_snapshot_by_username_get_route_400_no_existing(self) -> None:
        ...
        response: Response = self.client.get(
            "/v2/users/snapshot/bound2", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 400)
    ...
    def test_user_snapshot_by_username_get_route_200(self) -> None:
        ...
        # A very important song, but not a username used on the website.
        response: Response = self.client.get(
            "/v2/users/snapshot/andy", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 200)
    ...
    def test_user_snapshot_by_username_get_route_values_match_expected(self) -> None:
        """
        Test performing an HTTP GET request on the '/v2/users/snapshot/<username>' route.  This test proves that
        values in a snapshot match what are expected.
        """
        response: Response = self.client.get(
            "/v2/users/snapshot/dotty", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 200)
    ...
    def test_user_snapshot_by_username_get_route_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/users/snapshot/andy", AuthVariant.FORBIDDEN
        )
    ...
    def test_user_groups_by_username_get_route_200(self) -> None:
        ...
        """
        response: Response = self.client.get(
            "/v2/users/groups/andy", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 200)
    ...
    def test_user_groups_by_username_get_route_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/users/groups/andy", AuthVariant.FORBIDDEN
        )
    ...
    def test_user_groups_by_username_get_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/users/groups/andy", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_user_teams_by_username_get_route_200(self) -> None:
        ...
        """
        response: Response = self.client.get(
            "/v2/users/teams/andy", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 200)
    ...
    def test_user_teams_by_username_get_route_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/users/teams/andy", AuthVariant.FORBIDDEN
        )
    ...
    def test_user_teams_by_username_get_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/users/teams/andy", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_user_memberships_by_username_put_route_500_invalid_team(self) -> None:
        ...
        self.assertFalse(response_json.get("updated"))
        self.assertEqual(
            response_json.get("error"), "failed to update the user's memberships"
        )
    ...
    def test_user_flair_by_username_get_route_200(self) -> None:
        ...
        """
        response: Response = self.client.get(
            "/v2/users/flair/andy", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 200)
    ...
    def test_user_flair_by_username_get_route_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/users/flair/andy", AuthVariant.FORBIDDEN
        )
    ...
    def test_user_flair_by_username_get_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/users/flair/andy", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_user_statistics_by_username_get_route_200(self) -> None:
        ...
        """
        response: Response = self.client.get(
            "/v2/users/statistics/andy", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 200)
    ...
    def test_user_statistics_by_username_get_route_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/users/statistics/andy", AuthVariant.FORBIDDEN
        )
    ...
    def test_user_change_password_by_username_put_route_500_missing_required_field(
        self,
    ) -> None:
        """
        ...
        request_body = json.dumps({"forgot_password_code": "123456"})
    ...
    def test_user_change_password_by_username_put_route_500_invalid_code(self) -> None:
        ...
        """
        request_body = json.dumps(
            {"forgot_password_code": "123456", "new_password": "abcd1234"}
        )
        ...
        self.assertEqual(response_json.get("forgot_password_code_deleted"), False)
        self.assertEqual(
            response_json.get("error"), "This forgot password code is invalid."
        )

    def test_user_change_password_by_username_put_route_500_other_users_code(
        self,
    ) -> None:
        """
        Test performing an HTTP PUT request on the '/v2/users/<username>/change_password' route.  This test proves that
    ...
    def test_user_lookup_by_username_get_route_400(self) -> None:
        ...
        self.assertEqual(
            response_json.get("error"), "There is no user with this username or email."
        )
