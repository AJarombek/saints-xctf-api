...
class TestFlairRoute(TestSuite):
    def test_flair_post_route_redirect(self) -> None:
        ...
        response: Response = self.client.post(
            "/v2/flair", headers={"Authorization": f"Bearer {self.jwt}"}
        )
    ...
    def test_flair_post_route_redirect_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "POST", "/v2/flair", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_flair_post_route_400_missing_required_field(self) -> None:
        ...
        self.assertIsNone(response_json.get("flair"))
        self.assertEqual(
            response_json.get("error"), "'username' and 'flair' are required fields"
        )
    ...
    def test_flair_post_route_400_other_user(self) -> None:
        ...
        another user.
        """
        request_body = json.dumps({"username": "andy2", "flair": "Website Creator"})
    ...
    def test_flair_post_route_201(self) -> None:
        ...
        """
        request_body = json.dumps({"username": "andy", "flair": "Website Creator"})
