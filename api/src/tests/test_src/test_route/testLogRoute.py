...
class TestLogRoute(TestSuite):
    def test_log_get_route_redirect(self) -> None:
        ...
        response: Response = self.client.get(
            "/v2/logs", headers={"Authorization": f"Bearer {self.jwt}"}
        )
    ...
    def test_log_post_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "POST", "/v2/logs/", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_log_by_id_get_route_400(self) -> None:
        ...
        """
        response: Response = self.client.get(
            "/v2/logs/0", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 400)
        ...
        self.assertEqual(
            response_json.get("error"), "there is no log with this identifier"
        )
    ...
    def test_log_by_id_get_route_200(self) -> None:
        ...
        """
        response: Response = self.client.get(
            "/v2/logs/1", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 200)
    ...
    def test_log_by_id_get_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/logs/1", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_log_by_id_put_route_400_no_existing(self) -> None:
        ...
        self.assertIsNone(response_json.get("log"))
        self.assertEqual(
            response_json.get("error"), "there is no existing log with this id"
        )
    ...
    def test_log_by_id_put_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "PUT", "/v2/logs/1", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_log_by_id_delete_route_400_no_existing(self) -> None:
        ...
        self.assertEqual(
            "There is no existing exercise log with this id.",
            response_json.get("error"),
        )
    ...
    def test_log_by_id_delete_route_204(self) -> None:
        ...
        response: Response = self.client.delete(
            f"/v2/logs/{log_id}", headers={"Authorization": f"Bearer {self.jwt}"}
        )
    ...
    def test_log_by_id_delete_route_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "DELETE", "/v2/logs/1", AuthVariant.FORBIDDEN
        )
    ...
    def test_log_by_id_delete_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "DELETE", "/v2/logs/1", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_log_by_id_soft_delete_route_400_no_existing(self) -> None:
        ...
        response: Response = self.client.delete(
            "/v2/logs/soft/0", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 400)
        self.assertFalse(response_json.get("deleted"))
    ...
    def test_log_by_id_soft_delete_route_400_already_deleted(self) -> None:
        ...
        response: Response = self.client.delete(
            f"/v2/logs/soft/{log_id}", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        self.assertEqual(response.status_code, 204)
    ...
    def test_log_by_id_soft_delete_route_204(self) -> None:
        ...
        request_body = json.dumps(
            {
                ...
                "pace": "00:07:08",
                "feel": 5,
                "description": "Short run around the neighborhood after unloading Christmas trees this morning.",
        ...
        self.assertIsNone(response_json.get("log"))
        self.assertEqual(
            "there is no log with this identifier", response_json.get("error")
        )
    ...
    def test_log_by_id_soft_delete_route_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "DELETE", "/v2/logs/soft/1", AuthVariant.FORBIDDEN
        )
    ...
    def test_log_by_id_soft_delete_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "DELETE", "/v2/logs/soft/1", AuthVariant.UNAUTHORIZED
        )
