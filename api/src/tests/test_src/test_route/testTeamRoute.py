...
class TestTeamRoute(TestSuite):
    def test_team_get_route_redirect(self) -> None:
        ...
        response: Response = self.client.get(
            "/v2/teams", headers={"Authorization": f"Bearer {self.jwt}"}
        )
    ...
    def test_team_get_all_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/teams/", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_team_by_name_get_route_400(self) -> None:
        ...
        """
        response: Response = self.client.get(
            "/v2/teams/invalid", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
    ...
    def test_team_by_name_get_route_200(self) -> None:
        ...
        """
        response: Response = self.client.get(
            "/v2/teams/saintsxctf", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 200)
    ...
    def test_team_by_name_get_route_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/teams/saintsxctf", AuthVariant.FORBIDDEN
        )
    ...
    def test_team_by_name_get_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/teams/saintsxctf", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_team_members_by_team_name_get_route_400(self) -> None:
        ...
        """
        response: Response = self.client.get(
            "/v2/teams/members/invalid", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 400)
        ...
        self.assertEqual(
            response_json.get("error"), "the team does not exist or it has no members"
        )
    ...
    def test_team_groups_by_team_name_get_route_400(self) -> None:
        ...
        """
        response: Response = self.client.get(
            "/v2/teams/groups/invalid", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 400)
        ...
        self.assertEqual(
            response_json.get("error"), "the team does not exist or it has no groups"
        )
    ...
    def test_search_teams_by_team_name_get_route_200_no_matches(self) -> None:
        ...
        self.assertEqual(
            response_json.get("message"), "no teams were found with the provided text"
        )
    ...
    def test_search_teams_by_text_get_route_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/teams/search/St/5", AuthVariant.FORBIDDEN
        )
