...
class TestActivationCodeRoute(TestSuite):
    def test_activation_code_post_route_redirect(self) -> None:
        ...
        response: Response = self.client.post(
            "/v2/activation_code", headers={"Authorization": f"Bearer {self.jwt}"}
        )
    ...
    def test_activation_code_post_route_redirect_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "POST", "/v2/activation_code", AuthVariant.FORBIDDEN
        )
    ...
    def test_activation_code_post_route_redirect_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "POST", "/v2/activation_code", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_activation_code_post_route_400_empty_request(self) -> None:
        ...
        self.assertEqual(response_json.get("added"), False)
        self.assertEqual(
            response_json.get("error"), "'group_id' and 'email' are required fields"
        )
    ...
    def test_activation_code_exists_get_route_200(self) -> None:
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(
            response_json.get("self"), f"/v2/activation_code/exists/{activation_code}"
        )
    ...
    def test_activation_code_get_route_200(self) -> None:
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(
            response_json.get("self"), f"/v2/activation_code/{activation_code}"
        )
    ...
    def test_activation_code_get_route_400(self) -> None:
        ...
        self.assertEqual(
            response_json.get("error"), "there is no matching activation code"
        )
    ...
    def test_activation_code_soft_delete_route_400_other_users_code(self) -> None:
        ...
        self.assertEqual(response.status_code, 400)
        self.assertEqual(
            response_json.get("self"), f"/v2/activation_code/soft/{activation_code}"
        )
        self.assertFalse(response_json.get("deleted"))
        self.assertEqual(
            response_json.get("error"),
