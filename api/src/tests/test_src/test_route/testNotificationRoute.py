...
class TestNotificationRoute(TestSuite):
    def test_notification_get_route_redirect(self) -> None:
        ...
        response: Response = self.client.get(
            "/v2/notifications", headers={"Authorization": f"Bearer {self.jwt}"}
        )
    ...
    def test_notification_get_route_redirect_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/notifications", AuthVariant.FORBIDDEN
        )
    ...
    def test_notification_post_route_redirect_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "POST", "/v2/notifications", AuthVariant.FORBIDDEN
        )
    ...
    def test_notification_post_route_redirect_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "POST", "/v2/notifications", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_notification_by_id_get_route_400(self) -> None:
        ...
        """
        response: Response = self.client.get(
            "/v2/notifications/0", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 400)
        ...
        self.assertIsNone(response_json.get("notification"))
        self.assertEqual(
            response_json.get("error"), "there is no notification with this identifier"
        )
    ...
    def test_notification_by_id_get_route_200(self) -> None:
        ...
        """
        response: Response = self.client.get(
            "/v2/notifications/1", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 200)
    ...
    def test_notification_by_id_get_route_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/notifications/1", AuthVariant.FORBIDDEN
        )
    ...
    def test_notification_by_id_get_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "GET", "/v2/notifications/1", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_notification_by_id_put_route_400_no_existing(self) -> None:
        ...
        self.assertIsNone(response_json.get("notification"))
        self.assertEqual(
            response_json.get("error"), "there is no existing notification with this id"
        )
    ...
    def test_notification_by_id_put_route_400_other_users_notification(self) -> None:
        ...
        self.assertEqual(response.status_code, 400)
        self.assertEqual(
            response_json.get("self"), f"/v2/notifications/{notification_id}"
        )
        self.assertFalse(response_json.get("updated"))
        self.assertIsNone(response_json.get("notification"))
        self.assertEqual(
    ...
    def test_notification_by_id_put_route_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "PUT", "/v2/notifications/1", AuthVariant.FORBIDDEN
        )
    ...
    def test_notification_by_id_put_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "PUT", "/v2/notifications/1", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_notification_by_id_delete_route_forbidden(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "DELETE", "/v2/notifications/1", AuthVariant.FORBIDDEN
        )
    ...
    def test_notification_by_id_delete_route_unauthorized(self) -> None:
        ...
        """
        test_route_auth(
            self, self.client, "DELETE", "/v2/notifications/1", AuthVariant.UNAUTHORIZED
        )
    ...
    def test_notification_by_id_soft_delete_route_400_no_existing(self) -> None:
        ...
        response: Response = self.client.delete(
            "/v2/notifications/soft/0", headers={"Authorization": f"Bearer {self.jwt}"}
        )
        response_json: dict = response.get_json()
        self.assertEqual(response.status_code, 400)
        self.assertFalse(response_json.get("deleted"))

    def test_notification_by_id_soft_delete_route_400_other_users_notification(
        self,
    ) -> None:
        """
        Test performing an HTTP DELETE request on the '/v2/notifications/soft/<notification_id>' route.  This test
    ...
    def test_notification_by_id_soft_delete_route_204(self) -> None:
        ...
        self.assertIsNone(response_json.get("notification"))
        self.assertEqual(
            "there is no notification with this identifier", response_json.get("error")
        )
