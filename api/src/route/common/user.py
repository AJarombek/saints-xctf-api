...
def users_get(version: APIVersion, dao: Union[Type[UserDao], Type[UserDemoDao]]) -> Response:
    """
...
def user_by_username_get(username: str, version: APIVersion, dao: Union[Type[UserDao], Type[UserDemoDao]]) -> Response:
    """
